...
// --- Glossary / Term Map Prompts ---

const CHUNK_SUMMARY_PROMPT_TEMPLATE_GLOSSARY_TERM_MAP = (text: string) => `
...
const REDUCE_SUMMARIES_PROMPT_TEMPLATE_GLOSSARY_TERM_MAP = (text: string) => `
...
// --- Hierarchy of Needs / Pyramid Summary Prompts ---

const CHUNK_SUMMARY_PROMPT_TEMPLATE_HIERARCHY_OF_NEEDS = (text: string) => `
...
const REDUCE_SUMMARIES_PROMPT_TEMPLATE_HIERARCHY_OF_NEEDS = (text: string) => `
...
// --- Stakeholder Map Prompts ---

const CHUNK_SUMMARY_PROMPT_TEMPLATE_STAKEHOLDER_MAP = (text: string) => `
...
const REDUCE_SUMMARIES_PROMPT_TEMPLATE_STAKEHOLDER_MAP = (text: string) => `
...
// --- Constraint / Requirement List Prompts ---

const CHUNK_SUMMARY_PROMPT_TEMPLATE_CONSTRAINT_LIST = (text: string) => `
...
const REDUCE_SUMMARIES_PROMPT_TEMPLATE_CONSTRAINT_LIST = (text: string) => `
...
export const CHUNK_SUMMARY_PROMPTS = {
  ...
  glossaryTermMap: CHUNK_SUMMARY_PROMPT_TEMPLATE_GLOSSARY_TERM_MAP,
  hierarchyOfNeeds: CHUNK_SUMMARY_PROMPT_TEMPLATE_HIERARCHY_OF_NEEDS,
  stakeholderMap: CHUNK_SUMMARY_PROMPT_TEMPLATE_STAKEHOLDER_MAP,
  constraintList: CHUNK_SUMMARY_PROMPT_TEMPLATE_CONSTRAINT_LIST
};
...
export const REDUCE_SUMMARIES_PROMPTS = {
  ...
  glossaryTermMap: REDUCE_SUMMARIES_PROMPT_TEMPLATE_GLOSSARY_TERM_MAP,
  hierarchyOfNeeds: REDUCE_SUMMARIES_PROMPT_TEMPLATE_HIERARCHY_OF_NEEDS,
  stakeholderMap: REDUCE_SUMMARIES_PROMPT_TEMPLATE_STAKEHOLDER_MAP,
  constraintList: REDUCE_SUMMARIES_PROMPT_TEMPLATE_CONSTRAINT_LIST
};
