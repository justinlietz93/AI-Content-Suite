        ...
        <div className="animate-fade-in-scale space-y-6">
            ...
            <fieldset className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" id="project-name" value={settings.projectName} onChange={e => handleSettingChange('projectName', e.target.value)} placeholder="e.g., Comprehensive Codebase Summary" className="w-full px-3 py-2 bg-slate-700 border-border-color rounded-md text-sm" />
                </div>
                <div>
                    <Label htmlFor="persona-bias">Persona Bias</Label>
                    <select id="persona-bias" value={settings.persona} onChange={e => handleSettingChange('persona', e.target.value as SplitterPersona)} className="w-full px-3 py-2 bg-slate-700 border-border-color rounded-md text-sm">
