        ...
        <div className="animate-fade-in-scale space-y-6">
            ...
            <fieldset className="grid grid-cols-2 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" id="depth" value={settings.depth} onChange={e => handleSettingChange('depth', parseInt(e.target.value, 10))} min="1" className="w-full px-3 py-2 bg-input border border-border-color rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-ring" />
                </div>
                <div>
