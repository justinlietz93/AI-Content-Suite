...
export const UI_DIMENSIONS = {
  ...
  chat: {
    viewerMaxHeightRatio: 0.65,
    viewerMaxHeightMaxPx: 720,
 ...
 */
export const CHAT_VIEWER_MAX_HEIGHT = viewportClamp(
  UI_DIMENSIONS.chat.viewerMaxHeightRatio,
  UI_DIMENSIONS.chat.viewerMaxHeightMaxPx,
);
