...
5.  **Generate Markdown:** Create a clean, readable Markdown version of the enhanced prompt.
6.  **Generate JSON:** Create a structured JSON object representing the same enhanced prompt.
